...
🎓 MCA Student | 📊 Aspiring Data Analyst | 🤖 AI & ML Enthusiast  

I'm passionate about turning data into insights using Python, SQL, Excel, and visualization tools. I’m building real-world projects in data analytics and machine learning.
...
🔗 https://github.com/aditya-python-ai/ecommerce-sales-analysis  
- Sales & profit trend analysis  
- Interactive dashboards using Plotly  
- Customer segmentation insights  

### 🧾 Superstore Analysis Dashboard
- Regional & category-based sales analysis  
- Tools: Excel, Python  
...
- Actively preparing for data analyst interviews  
